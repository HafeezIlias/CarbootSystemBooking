...
module.exports = {
  ...
  callbackUrl: process.env.NODE_ENV === 'production' 
    ? process.env.BILLPLZ_CALLBACK_URL || 'http://carbootsoc.feeyazproduction.com/api/payments/webhook'
    : 'http://localhost:5000/api/payments/webhook',
  
  // Redirect URLs for production
  redirectUrl: process.env.NODE_ENV === 'production'
    ? process.env.BILLPLZ_REDIRECT_URL || 'http://carbootsoc.feeyazproduction.com/payment/status'
